...
(
    ...
    case "$HOST" in
        *mingw*)
            ...
            mv build/viacoin-win64-setup.exe "${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    (
        ...
        cp "${DISTSRC}/share/examples/bitcoin.conf" "${DISTNAME}/viacoin.conf"
    ...
    case "$HOST" in
        ...
        *darwin*)
            ...
            mv build/dist/Viacoin-Core.zip "${OUTDIR}/${DISTNAME}-${HOST}-unsigned.zip"
