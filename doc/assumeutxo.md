...
Assumeutxo is a feature that allows fast bootstrapping of a validating viacoind
instance.

For notes on the design of Assumeutxo, please refer to [the design doc](/doc/design/assumeutxo.md).

For Viacoin-specific instructions including platform-specific guides and
current snapshot data, see [viacoin-assumeutxo.md](/doc/viacoin-assumeutxo.md).
...
```
$ viacoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ viacoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
