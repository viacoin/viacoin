# Support for Output Descriptors in Viacoin Core

Since Viacoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `via1...` for mainnet or `tvia1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Viacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Viacoin Core wallets, a convenience function `combo` is
