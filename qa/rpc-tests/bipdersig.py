...
class BIP66Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if (self.nodes[0].getblockcount() != cnt + 1050):
            raise AssertionError("Failed to mine a version=3 block after 949 version=3 blocks")
        ...
        try:
            self.nodes[1].setgenerate(True, 1)
            raise AssertionError("Succeeded to mine a version=3 block after 950 version=3 blocks")
        except JSONRPCException:
            pass
        self.sync_all()
        if (self.nodes[0].getblockcount() != cnt + 1051):
            raise AssertionError("Accepted a version=3 block after 950 version=3 blocks")
