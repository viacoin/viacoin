...
"""Verify that starting viacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start viacoin with -h for help text")
        ...
        self.log.info("Start viacoin with -version for version information")
        ...
        self.log.info("Start viacoind with -fakearg to make sure it does not start")
