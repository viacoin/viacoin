...
class TestNode():
    ...
    def __init__(
        ...
        *,
        ...
        self.bitcoinconf = self.datadir_path / "viacoin.conf"
        ...
        # Configuration for logging is set as command-line args rather than in the viacoin.conf file.
    ...
    def start(self, extra_args=None, *, cwd=None, stdout=None, stderr=None, env=None, **kwargs):
        ...
        # viacoin.conf. To avoid collisions, change it to 127.0.0.1:tor_port().
