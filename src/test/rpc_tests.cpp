...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    r = CallRPC(std::string("createrawtransaction ")+prevout+" "+
      "{\"Vq8z4SFxYGF7ksXPPHb95t3SzpmaZEkt9g\":11}");
    std::string notsigned = r.get_str();
    std::string privkey1 = "\"WW3Ja4Q2AS8pZpbHnPLtUn7gp9yCRdF7fi37RBpowgbPVfL4r4bo\"";
    std::string privkey2 = "\"WUsQFXvmkNUiFRadRMcZiES3qMzoh2K8qKPaUGr8CnXpimWPNEt4\"";
...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> viacoin-cli -named test foo=bar b=true n=1\n");
    ...
    // test shell escape
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> viacoin-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> viacoin-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> viacoin-cli -named test foo='b ar'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> viacoin-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> viacoin-cli -named test name='[\"bar\",false,1]'\n");
