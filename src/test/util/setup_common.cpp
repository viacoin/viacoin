...
constexpr inline auto TEST_DIR_PATH_ELEMENT{"test_common viacoin"}; // Includes a space to catch possible path escape issues.
    ...
    : TestingSetup{ChainType::REGTEST, opts}
{
    ...
    this->mineBlocks(COINBASE_MATURITY_REGTEST);
