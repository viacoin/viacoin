...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " viacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  viacoin-tx [options] <hex-tx> [commands]  Update hex-encoded viacoin transaction\n" +
            "or:     viacoin-tx [options] -create [commands]   Create hex-encoded viacoin transaction\n" +
            "\n";
