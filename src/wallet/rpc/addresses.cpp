...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{
        ...
        "Returns a new Bitcoin address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new viacoin address"
                },
                RPCExamples{
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The viacoin address"},
...
RPCHelpMan getaddressinfo()
{
    return RPCHelpMan{
        ...
        "Return information about the given viacoin address.\n"
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The viacoin address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The viacoin address validated."},
...
RPCHelpMan walletdisplayaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "viacoin address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
