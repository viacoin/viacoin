...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"To use viacoind, or the -server option to viacoin-qt, you must set an "
...
"your clock is wrong Viacoin Core will not work properly."),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Copyright (C) 2009-%i The Bitcoin Core Developers, Copyright (C) 2014-%i The Viacoin Core Developers,"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of Viacoin Core"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. Viacoin Core is shutting down."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart Viacoin Core to complete"),
