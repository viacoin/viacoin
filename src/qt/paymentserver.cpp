...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        if (arg.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // viacoin: URI
        {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("viacoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'viacoin://' is not a valid URI. Use 'viacoin:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // viacoin: URI
    {
