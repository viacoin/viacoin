...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (viacoin-cli -rpcclienttimeout=0)",
                {
        ...
        {RPCResult::Type::OBJ, "", "",
        {
            ...
            {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
            {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                {
                    ...
                    {RPCResult::Type::STR, "address", /*optional=*/true, "The Viacoin address (only if a well-defined address exists)"},
...
UniValue DeploymentInfo(const CBlockIndex* blockindex, const ChainstateManager& chainman)
{
    ...
    SoftForkDescPushBack(blockindex, softforks, chainman, Consensus::DEPLOYMENT_VIACOIN_CSV);
    SoftForkDescPushBack(blockindex, softforks, chainman, Consensus::DEPLOYMENT_VIACOIN_SEGWIT);
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (viacoin-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (viacoin-cli -rpcclienttimeout=0)",
        {
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable viacoind instance that is current with the network tip in a "
