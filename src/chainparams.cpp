...
public:
    CMainParams() {
        ...
        consensus.SegwitHeight = 4040000;
        ...
        // Lay off signaling until we know have some statistics on miners upgrading etc
        ...
        vSeeds.emplace_back("seed.viacoin.net.");
        vSeeds.emplace_back("mainnet.viacoin.net");
        ...
        checkpointData = {
            {
                ...
                { 11160757, uint256S("0xe820d250e497f281788f34dc98b5d007aca2735a5d1ecf6e819e8e7c363753a1")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.CSVHeight = 770112; // TODO: figure out actual height
        consensus.SegwitHeight = 4040000;
        consensus.MinBIP9WarningHeight = 4043600;
